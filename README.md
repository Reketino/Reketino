...
**Experienced with:**
[![My Skills](https://skillicons.dev/icons?i=ts,js,html,css,tailwind,react,nextjs,npm,nodejs,python,supabase,vscode,git,github,photoshop,pr,ae)](https://skillicons.dev)
